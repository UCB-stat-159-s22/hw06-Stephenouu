...
for det in dets:
    ...
    utils.plot_helper(make_plots, det, time, timemax, SNR, template_match, eventname, plottype, tevent,
                      template_fft, datafreq, d_eff, freqs, data_psd, strain_H1_whitenbp, fs, strain_L1_whitenbp)
